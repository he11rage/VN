...
label Chapter_2:
    ...
    prof smile "Доброе утро, Аля! Рад, что ты пришла."
...
label Chapter_3:
    ...
    prof smile "Это Аля. Она интересуется IT, но ещё не определилась с направлением. Думаю, ты сможешь рассказать ей о геймдизайне."
...
label Chapter_6:
    ...
    show aly interesting with dissolve
...
label Chapter_7:
    ...
    aly smile "Я подумаю над этим. Сегодня я поняла, насколько это интересно и многогранно."
    # Конец 7 ГЛАВЫ
