...
label start:
    ...
    aly "Я вот думаю, что будет дальше. Какая у меня будет профессия, как выбрать ту самую, из десятка других… Все так непонятно, будто в тумане."
    ...
    aly "Нуууу... Мне программирование нравится."
    prof "Отлично, нам как раз нужны новые кадры, меня зовут профессор, работаю в одной IT компании, не хочешь посмотреть, как мы работаем? "
    ...
    '''
    aly "Да, хочу. Но я еще не решила, кем хочу стать."
...
label Chapter_2:
    ...
    show aly normal at right with fade
    aly ''' “Техноград”… 
    ...
    show prof normal at left with fade
...
label Chapter_6:
    ...
    prof "Ах да, совершенно забыл. Спасибо, Олег. "
    hide unknownman
    with dissolve
    prof "Аля, мне нужно идти. Ты можешь ещё немного погулять здесь или я провожу тебя к выходу?"
    
    aly "Не беспокойтесь, я сама доберусь. Хочу ещё немного осмотреться, если можно."
    prof "Конечно, чувствуй себя как дома. Только не заходи в помещения с пометкой 'Доступ ограничен'."
    ...
    aly "Эй! Кто здесь? Я случайно зашла! Откройте дверь, пожалуйста!"
    ...
    prof "Аля, быстрее за мной! Нам нужно добраться до панели управления, чтобы отключить протокол безопасности"
    show prof normal at center
    with move

    prof "Агх, автоматические системы заблокированны, придется делать всё в ручную"
    prof "Аля, помоги мне"
    ...
    prof "Извини, Аля. Ты в порядке?"

    aly "Да, кажется, всё хорошо. Что это за место?"
    prof "Пойдём, я всё объясню."
    ...
    prof "Проект очень важен и потенциально опасен, если попадёт не в те руки. Поэтому мы тщательно охраняем его."
    aly "Понимаю. Извините, что вошла без разрешения."
    prof "Всё в порядке. Главное, что ты не пострадала. Но, пожалуйста, никому об этом не рассказывай."
    aly "Обещаю. Ваш секрет — в надёжных руках."
...
label Chapter_7:
    ...
    aly "Спасибо вам огромное за эту возможность. Теперь я чувствую себя гораздо увереннее."
    ...
    aly "Я подумаю над этим. Сегодня я поняла, насколько это интересно и многогранно."
    # Конец 7 ГЛАВЫ
